...
class GameScene:
    def __init__(self, screen):
        ...
        self.obstacles = [
            ...
            # Край карти
                # Нижній
            Obstacle(0, 600), Obstacle(50, 600),
            Obstacle(100, 600), Obstacle(150, 600),
            Obstacle(200, 600), Obstacle(250, 600),
            Obstacle(300, 600), Obstacle(350, 600),
            Obstacle(400, 600), Obstacle(450, 600),
            Obstacle(500, 600), Obstacle(550, 600),
            Obstacle(600, 600), Obstacle(650, 600),
            Obstacle(700, 600), Obstacle(750, 600),
            Obstacle(800, 600),
                # Верхній
            Obstacle(0, 600), Obstacle(50, 600),
            Obstacle(100, 600), Obstacle(150, 600),
        ...
        self.enemies = [Enemy(200, 550, direction="up"), Enemy(550, 550, direction="up"),
                        Enemy(600, 0),Enemy(150, 550),Enemy(50, 550, direction="up"), Enemy(700, 550, direction="up")]
        self.bullets = []
