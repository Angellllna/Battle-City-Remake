from entities.obstacle import SteelBlock, WaterBlock, BushBlock, Shield
...
def create_test_map():
    ...
    # Щит
    obstacles.append(Shield(300, 250, "up"))
    obstacles.append(Shield(350, 250, "down"))
    obstacles.append(Shield(400, 250, "left"))
    obstacles.append(Shield(450, 250, "right"))
